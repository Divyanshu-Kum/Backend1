...
const loginUser = asyncHandler(async (req, res) => {
       ...
       // Here is an alternative of above code base on logic discussed in video
       // if (!(username || email)) {
       //throw new ApiError(400, "username or email is required")
    ...
    const logoutUser = asyncHandler(async(req, res) => {
       ...
       return res
       .statusCookie("accessToken", options)
       .clearCookie("refreshToken", options)
       .json(new ApiResponse(200, {}, "User logged Out"))
    })

    // refresh accesstolen endpoints

    const refreshToken = asyncHandler(async (req, res) => {

       const incomingRefreshToken = req.cookies.refreshToken || req.cookie.refreshToken
...
const getCurrentUser = as(async(req, res) => {
       return res
       .status(200)
     ...
     const getUserChannelProfile = asyncHandler(async(req, res) => {
       ...
       const channel = await User.aggregate([
              ...
              },
              {
                  ...
                  if (!channel?.length) {
                     throw new ApiError(404, "channem does not exist")
                  }
